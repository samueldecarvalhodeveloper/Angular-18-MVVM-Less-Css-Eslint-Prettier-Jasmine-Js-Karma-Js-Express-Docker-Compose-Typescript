...
describe('Test Screen "Calculator" Behavior', () => {
  ...
  it("Test If Components Are Rendered", () => {
  ...
  it("Test If Button Handlers Do Their Role And Update Calculator Value On User Interface", () => {
  ...
  it("Test If Evaluate Button Evaluates Calculation Expression On Calculator And Updates Calculator Value On User Interface", () => {
    const calculatorValueElement = debugComponent.query(
      By.css(DATA_TEST_ID_CSS_SELECTOR(CALCULATOR_VALUE_TEST_ID)),
    ).nativeElement as HTMLElement;
  ...
  it("Test If Clean Button Cleans Calculation Expression On Calculator And Updates Calculator Value On User Interface", () => {
    const calculatorValueElement = debugComponent.query(
      By.css(DATA_TEST_ID_CSS_SELECTOR(CALCULATOR_VALUE_TEST_ID)),
    ).nativeElement as HTMLElement;
